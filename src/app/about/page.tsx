...
export default function About() {
  return (
    <main className="min-h-screen  bg-gradient-to-b from-blue-50 to-white">
      ...
      {/* HERO SECTION */}
      <section className="text-center pt-24 pb-16 bg-gradient-to-b from-blue-50 to-gray-50">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-20">
        ...
        <div className="bg-white border rounded-2xl p-8 md:p-12 shadow-sm">
          ...
          {/* DEVELOPER CARD */}
          <div className="mt-10 p-6 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border">
        ...
        <div className="mt-10 grid md:grid-cols-2 gap-6">
          ...
          {/* MISSION */}
          <div className="p-8 bg-gradient-to-br from-white to-indigo-50 border border-indigo-100 rounded-2xl shadow-sm hover:shadow-lg transition duration-300 hover:-translate-y-1">
          ...
          {/* TECHNOLOGY */}
          <div className="p-8 bg-gradient-to-br from-white to-blue-50 border border-blue-100 rounded-2xl shadow-sm hover:shadow-lg transition duration-300 hover:-translate-y-1">
